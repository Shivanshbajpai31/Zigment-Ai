    ...
    <div className="bg-white dark:bg-gray-800 p-3 md:p-6  rounded shadow w-full">
      {isSchemaValid && (
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-3">
          <h2 className=" sm:text-2xl text-2xl font-bold text-gray-900 dark:text-gray-200 ">
            {schema.formTitle}
          </h2>
          ...
          <div className="space-y-3">
            ...
            <button type="reset" onClick={() => reset()} className="w-full bg-gray-500 dark:bg-gray-700 text-white py-2 rounded hover:bg-gray-600">
              Reset
            </button>
